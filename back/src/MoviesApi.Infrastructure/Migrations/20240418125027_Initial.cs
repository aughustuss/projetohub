        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenLifetime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EmailConfirmTokenLifetime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserWithFavoriteListId = table.Column<int>(type: "int", nullable: true),
                    UserWithWatchedListId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movies_Users_UserWithFavoriteListId",
                        column: x => x.UserWithFavoriteListId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Movies_Users_UserWithWatchedListId",
                        column: x => x.UserWithWatchedListId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieCompanies", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_UserWithFavoriteListId",
                table: "Movies",
                column: "UserWithFavoriteListId");

            migrationBuilder.CreateIndex(
                name: "IX_Movies_UserWithWatchedListId",
                table: "Movies",
                column: "UserWithWatchedListId");
        }
